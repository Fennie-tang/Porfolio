...
const services = [
  {
    name: "Web Design",
    description: "Creating eye-catching web applications.",
  },
  {
    name: "Development",
    description: "Creating Full-Stack web applications.",
  },
  {
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          >
            ...
            <h3 className="h3 max-w-[455px] mb-16">
              I am Full-Stack Developer with an eye for design. I'm excited to
